    ...
    return <View style={styles.container}>
        ...
        <View style={styles.accountInfoSection}>
            <Pressable onPress={() => {
                ...
                <Image source={require('../assets/shin.png')} style={styles.accountInfoImage} />
        ...
        <View style={{ paddingHorizontal: 14, gap: 12 }}>
            ...
            <Pressable style={styles.accountButtons}>
                <FontAwesome name="diamond" style={{ height: 35, width: 35 }} size={24} color="black" />
        ...
        <View style={{ paddingHorizontal: 14, gap: 12 }}>
            <Pressable style={styles.accountButtons}>
                <Fontisto name="email" style={{ height: 35, width: 35 }} size={24} color="black" />
                <Text style={styles.accountButtonsText}>Email Settings</Text>
            </Pressable>
            <Pressable style={styles.accountButtons}>
                <Feather name="bell" style={{ height: 32, width: 32 }} size={24} color="black" />
                <Text style={styles.accountButtonsText}>Device and push notification settings</Text>
            </Pressable>
            <Pressable style={styles.accountButtons}>
                <Feather name="lock" style={{ height: 32, width: 32 }} size={24} color="black" />
        ...
        <View style={{ paddingHorizontal: 14, gap: 12 }}>
            <Pressable style={styles.accountButtons}>
                <Feather name="star" style={{ height: 34, width: 34 }} size={28} color="black" />
                <Text style={styles.accountButtonsText}>Rate Splitwise</Text>
            </Pressable>
            <Pressable style={styles.accountButtons}>
                <MaterialIcons name="support-agent" style={{ height: 35, width: 35 }} size={28} color="black" />
        ...
        <View style={{ paddingHorizontal: 14, gap: 12 }}>
            <Pressable style={styles.accountButtons}>
                <AntDesign name="logout" style={{ height: 32, width: 32 }} size={28} color="black" />
